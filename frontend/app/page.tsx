      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        <div className="flex items-center justify-between px-8 py-4 bg-white border-b border-gray-100 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => { const next = !darkMode; setDarkMode(next); localStorage.setItem('cnvrted_dark', String(next)) }}
              className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center hover:bg-gray-100 transition text-gray-500">
              {darkMode
