                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {(() => {
                            const profileUrl = lead.platform === 'twitter'
                              ? (lead.contact_linkedin || lead.source_url)
                              : lead.platform === 'reddit'
                              ? (lead.source_url ? `https://reddit.com/user/${lead.author}` : '')
                              : lead.contact_linkedin
                            return profileUrl ? (
                              <a href={profileUrl} target="_blank" rel="noopener noreferrer" className="shrink-0 hover:opacity-70 transition">
                                {lead.platform === 'reddit' ? (
